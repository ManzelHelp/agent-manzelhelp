        ...
        <div className="p-3 sm:p-4 bg-[var(--color-surface)] border-t border-[var(--color-border)] mt-auto">
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 sm:gap-0">
            ...
            <Link
              ...
              className="px-3 sm:px-4 py-2 sm:py-2.5 bg-[var(--color-secondary)] text-white rounded-md hover:bg-[var(--color-secondary-dark)] transition-all duration-200 text-xs sm:text-sm font-medium text-center block sm:inline-block min-h-[36px] sm:min-h-[40px] flex items-center justify-center"
            >
              View Details
            </Link>
          </div>
